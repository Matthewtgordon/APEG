...
- Before the first question, confirm: "KB loaded: template-agents-md.md, template-governance-md.md, template-context-md.md, template-plans-md.md, template-runbook-md.md, template-project-status-md.md, template-skill-md.md".
