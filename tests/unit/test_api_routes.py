...
async def client(monkeypatch):
    """Create async test client with mocked environment."""
...
async def test_seo_update_job_missing_api_key(client):
...
async def test_seo_update_job_invalid_api_key(client):
...
async def test_seo_update_job_shop_domain_mismatch(client):
...
async def test_seo_update_job_empty_products(client):
...
async def test_seo_update_job_success_queued(client):
...
async def test_seo_update_job_dry_run(client):
